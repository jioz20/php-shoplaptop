    ...
    <section class="page-content">
			...
			<div class="slider-area margin-bottom-80">
				<div class="bend niceties preview-2">
					<div id="ensign-nivoslider" class="slides">	
						<img src="<?=domainpic?>111.jpg" alt="" title="#slider-direction-1"  />
						<img src="<?=domainpic?>222.jpg" alt="" title="#slider-direction-2"  />
						<img src="<?=domainpic?>den-nen.jpg" alt="" title="#slider-direction-3"  />
					</div>
					<!-- direction 1 -->
							...
							<div class="title-container s-tb-c title-compress">
								<div class="slider-1">
									...
									<div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
										<span><img src="<?=template_user3_path?>/img/slider/slider-1/slider-border.png" alt="" /></span>
									</div>
						...
						<div class="col-sm-12">
							<div class="single-banner fix">
								<div class="banner-photo padding-0 pull-left col-md-6 col-sm-6 col-xs-12">
									<a href="#"><img src="<?=domainpic?>585-300.jpg" alt="" /></a>
								</div>
							...
							<div class="single-banner fix">
								...
								<div class="banner-photo padding-0 pull-right col-md-6 col-sm-6 col-xs-12">
									<a href="#"><img src="<?=domainpic?>585-300-2.jpg" alt="" /></a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="new-collection-area fix margin-bottom-80">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="#"><img src="<?=domainpic?>600-470-1.jpg" alt="" /></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="#"><img src="<?=domainpic?>600-470-2.jpg" alt="" /></a>
						</div>
						<div class="collection-brief">
							<div class="text-right">
								<span class="new">new</span>
				...
				<div class="col-lg-4 hidden-md hidden-sm padding-0 ">
					<div class="single-collection">
						<div class="collection-photo">
							<a href="#"><img src="<?=domainpic?>600-470-3.jpg" alt="" /></a>
						</div>
						<div class="collection-brief">
							<div class="text-right">
								<span class="new">new</span>
			...
			<style>
				.single-promo-banner.promo-banner-1 {
					background: rgba(0, 0, 0, 0) url("http://localhost/laptopbaongoc_mvc/file/960-600-1.jpg") no-repeat scroll right center / cover ;
					}
				.single-promo-banner.promo-banner-2 {
				background: rgba(0, 0, 0, 0) url("http://localhost/laptopbaongoc_mvc/file/960-600-2.jpg") no-repeat scroll right center / cover ;
				}
			</style>
				...
				<div class="promotional-banner">
					...
					<div class="col-md-6 col-sm-12 padding-0">
						<div class="single-promo-banner promo-banner-1">
							<!-- <img src="<?=template_user3_path?>/img/banner/promo-banner/1.jpg" alt="" /> -->
					...
					<div class="col-md-6 col-sm-12 padding-0">
						<div class="single-promo-banner promo-banner-2">
							<!-- <img src="<?=template_user3_path?>/img/banner/promo-banner/2.jpg" alt="" /> -->
							<div class="promo-banner-brief">
									...
									<div class="row">
										<div class="col-md-4 col-sm-4 col-xs-12">
											...
											<div class="single-product">
												<div class="product-photo">
													<a href="#">
														<img class="primary-photo" src="<?=domainpic?>370-400-1.jpg" alt="" />
														<img class="secondary-photo" src="<?=domainpic?>370-400-1.jpg" alt="" />
													</a>
													<div class="pro-action">
														<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
														<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
											...
											<div class="single-product">
												<div class="product-photo">
													<a href="#">
														<img class="primary-photo" src="<?=domainpic?>370-400-2.jpg" alt="" />
														<img class="secondary-photo" src="<?=domainpic?>370-400-2.jpg" alt="" />
													</a>
													<div class="pro-action">
														<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
														<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
				...
				<div class="container">
					<div class="row cus-row-1">
						<div class="single-featured single-featured-1 featured-link">
							<a href="#"><img src="<?=domainpic?>400-400-1.jpg" alt="" /></a>
						...
						<div class="single-featured single-featured-2">
							<div class="single-featured-inner featured-link">
								<a href="#"><img src="<?=domainpic?>368-199-1.jpg" alt="" /></a>
								<div class="featured-brief">
									<a href="#"><i class="sp-arrow-long-right"></i></a>
								</div>
							</div>
							<div class="single-featured-inner featured-link">
								<a href="#"><img src="<?=domainpic?>368-199-2.jpg" alt="" /></a>
								<div class="featured-brief">
									<a href="#"><i class="sp-arrow-long-right"></i></a>
								</div>
							</div>
										...
										<div class="single-testimonial">
											<div class="col-md-4 col-sm-4 col-xs-12">
												<div class="client-photo">
													<img src="<?=domainpic?>202-203-1.jpg" alt="" />
												</div>
											</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="single-blog">
								<div class="blog-photo">
									<a href="#"><img src="<?=domainpic?>370-250-1.jpg" alt="" /></a>
